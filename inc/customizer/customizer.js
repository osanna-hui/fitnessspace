jQuery(document).ready( function( $ ) {
	...
	var sliderControls = jQuery('#customize-control-slider_image_id01, #customize-control-slider_image_id02');
	...
	jQuery('#customize-control-slider_type_id select').on('change', function(){ 
		...
		if(jQuery(this).find('option:selected').val() == 'ImageSlider'){
			...
			$('#customize-control-slider_image_id01').removeClass('hideslider');
		}
