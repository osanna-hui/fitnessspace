...
function fitnessspace_option_defaults() {
	$defaults = array(
		...
		'about_title_text' => __('WELCOME', 'fitnessspace'),
		'about_desc_text' => __('LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISCING ELIT.', 'fitnessspace'),
		...
		'slider_text' => __('DEMO', 'fitnessspace'),
		'slider_txt_color' => '#ffffff',
		'static_textbox_width' => '85',
		'static_textbox_bottom' => '15',
		'slider_content_align' =>'center',
		'classes_image_id' => array(  'url'=>''.get_template_directory_uri().'/img/unsplash_slider04.jpeg'),
